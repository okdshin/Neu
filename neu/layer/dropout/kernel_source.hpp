#ifndef NEU_LAYER_DROPOUT_KERNEL_SOURCE_HPP
#define NEU_LAYER_DROPOUT_KERNEL_SOURCE_HPP
//20151023
#include <boost/compute/utility/source.hpp>
namespace neu {
	constexpr char dropout_test_forward_kernel_source[] = BOOST_COMPUTE_STRINGIZE_SOURCE(
	...
	constexpr char dropout_forward_kernel_source[] = BOOST_COMPUTE_STRINGIZE_SOURCE(
	...
	constexpr char dropout_backward_kernel_source[] = BOOST_COMPUTE_STRINGIZE_SOURCE(
...
#endif //NEU_LAYER_DROPOUT_KERNEL_SOURCE_HPP
